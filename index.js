jQuery(() => {
    ...
    styleEl.textContent = [
        ...
        ".bny-header { display:flex; align-items:center; padding:8px 10px; background:#fff; border-bottom:1px solid #fde2e8; gap:5px; flex-shrink:0; }",
    ...
    function moveTo(x, y) {
        ...
        posY = y;
        fab.style.left = x + "px";
        fab.style.top = y + "px";if (panelOpen) positionPanel();
    }
    ...
    function hideFab() {
        fab.style.display = "none";closePanel();
    }
